 ...
 */
class PageFactory implements ControllerFactoryInterface, RequestHandlerInterface
{
    /**
    ...
    public function getControllerClass(ServerRequest $request): ?string
    {
        ...
        $action = strtoupper($firstChar) . substr($action, 1);

        /** @var class-string<\Cake\Controller\Controller>|null */
        return App::className($pluginPath . $action, $namespace, 'Page');
    }
